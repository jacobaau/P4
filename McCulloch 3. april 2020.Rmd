...
z[14] <- obl[14,3] - crossprod(ydelse14, matrix(c(1:1), ncol=1, nrow = length(ydelse14)))
z
```
...
beta0[14] <- crossprod(ydelse14, tid14)
...
gamma0[14] <- crossprod(ydelse14, tid14^2)
...
delta0[14] <- crossprod(ydelse14, tid14^3)
...
tau2 <- tail(tid7,n=1)+ theta1*(tail(tid8,n=1)-tail(tid7, n=1))
tau3 <- tail(tid10,n=1)+ theta1*(tail(tid11,n=1)-tail(tid10, n=1))
tau4 <- tail(tid14, n=1)
tau1
tau2
tau3
...
delta1[14] <- ydelse14[1]*(tid14[1]-tau1)^3*stepfunktion1(tid14[1]) +
              ydelse14[2]*(tid14[2]-tau1)^3*stepfunktion1(tid14[2]) +
              ydelse14[3]*(tid14[3]-tau1)^3*stepfunktion1(tid14[3]) +
              ydelse14[4]*(tid14[4]-tau1)^3*stepfunktion1(tid14[4]) +
              ydelse14[5]*(tid14[5]-tau1)^3*stepfunktion1(tid14[5]) +
              ydelse14[6]*(tid14[6]-tau1)^3*stepfunktion1(tid14[6]) +
              ydelse14[7]*(tid14[7]-tau1)^3*stepfunktion1(tid14[7]) +
              ydelse14[8]*(tid14[8]-tau1)^3*stepfunktion1(tid14[8]) +
              ydelse14[9]*(tid14[9]-tau1)^3*stepfunktion1(tid14[9]) + 
              ydelse14[10]*(tid14[10]-tau1)^3*stepfunktion1(tid14[10]) +
              ydelse14[11]*(tid14[11]-tau1)^3*stepfunktion1(tid14[11]) +
              ydelse14[12]*(tid14[12]-tau1)^3*stepfunktion1(tid14[12]) +
              ydelse14[13]*(tid14[13]-tau1)^3*stepfunktion1(tid14[13]) +
              ydelse14[14]*(tid14[14]-tau1)^3*stepfunktion1(tid14[14]) +
              ydelse14[15]*(tid14[15]-tau1)^3*stepfunktion1(tid14[15]) +
              ydelse14[16]*(tid14[16]-tau1)^3*stepfunktion1(tid14[16]) +
              ydelse14[17]*(tid14[17]-tau1)^3*stepfunktion1(tid14[17]) +
              ydelse14[18]*(tid14[18]-tau1)^3*stepfunktion1(tid14[18]) +
              ydelse14[19]*(tid14[19]-tau1)^3*stepfunktion1(tid14[19]) + 
              ydelse14[20]*(tid14[20]-tau1)^3*stepfunktion1(tid14[20]) +
              ydelse14[21]*(tid14[21]-tau1)^3*stepfunktion1(tid14[21]) +
              ydelse14[22]*(tid14[22]-tau1)^3*stepfunktion1(tid14[22]) +
              ydelse14[23]*(tid14[23]-tau1)^3*stepfunktion1(tid14[23]) +
              ydelse14[24]*(tid14[24]-tau1)^3*stepfunktion1(tid14[24]) +
              ydelse14[25]*(tid14[25]-tau1)^3*stepfunktion1(tid14[25]) +
              ydelse14[26]*(tid14[26]-tau1)^3*stepfunktion1(tid14[26]) +
              ydelse14[27]*(tid14[27]-tau1)^3*stepfunktion1(tid14[27]) +
              ydelse14[28]*(tid14[28]-tau1)^3*stepfunktion1(tid14[28]) +
              ydelse14[29]*(tid14[29]-tau1)^3*stepfunktion1(tid14[29]) +
              ydelse14[30]*(tid14[30]-tau1)^3*stepfunktion1(tid14[30]) + 
              ydelse14[31]*(tid14[31]-tau1)^3*stepfunktion1(tid14[31]) +
              ydelse14[32]*(tid14[32]-tau1)^3*stepfunktion1(tid14[32]) +
              ydelse14[33]*(tid14[33]-tau1)^3*stepfunktion1(tid14[33])
delta1
...
delta2[14] <- ydelse14[1]*(tid14[1]-tau2)^3*stepfunktion2(tid14[1]) +
              ydelse14[2]*(tid14[2]-tau2)^3*stepfunktion2(tid14[2]) +
              ydelse14[3]*(tid14[3]-tau2)^3*stepfunktion2(tid14[3]) +
              ydelse14[4]*(tid14[4]-tau2)^3*stepfunktion2(tid14[4]) +
              ydelse14[5]*(tid14[5]-tau2)^3*stepfunktion2(tid14[5]) +
              ydelse14[6]*(tid14[6]-tau2)^3*stepfunktion2(tid14[6]) +
              ydelse14[7]*(tid14[7]-tau2)^3*stepfunktion2(tid14[7]) +
              ydelse14[8]*(tid14[8]-tau2)^3*stepfunktion2(tid14[8]) +
              ydelse14[9]*(tid14[9]-tau2)^3*stepfunktion2(tid14[9]) + 
              ydelse14[10]*(tid14[10]-tau2)^3*stepfunktion2(tid14[10]) +
              ydelse14[11]*(tid14[11]-tau2)^3*stepfunktion2(tid14[11]) +
              ydelse14[12]*(tid14[12]-tau2)^3*stepfunktion2(tid14[12]) +
              ydelse14[13]*(tid14[13]-tau2)^3*stepfunktion2(tid14[13]) +
              ydelse14[14]*(tid14[14]-tau2)^3*stepfunktion2(tid14[14]) +
              ydelse14[15]*(tid14[15]-tau2)^3*stepfunktion2(tid14[15]) +
              ydelse14[16]*(tid14[16]-tau2)^3*stepfunktion2(tid14[16]) +
              ydelse14[17]*(tid14[17]-tau2)^3*stepfunktion2(tid14[17]) +
              ydelse14[18]*(tid14[18]-tau2)^3*stepfunktion2(tid14[18]) +
              ydelse14[19]*(tid14[19]-tau2)^3*stepfunktion2(tid14[19]) + 
              ydelse14[20]*(tid14[20]-tau2)^3*stepfunktion2(tid14[20]) +
              ydelse14[21]*(tid14[21]-tau2)^3*stepfunktion2(tid14[21]) +
              ydelse14[22]*(tid14[22]-tau2)^3*stepfunktion2(tid14[22]) +
              ydelse14[23]*(tid14[23]-tau2)^3*stepfunktion2(tid14[23]) +
              ydelse14[24]*(tid14[24]-tau2)^3*stepfunktion2(tid14[24]) +
              ydelse14[25]*(tid14[25]-tau2)^3*stepfunktion2(tid14[25]) +
              ydelse14[26]*(tid14[26]-tau2)^3*stepfunktion2(tid14[26]) +
              ydelse14[27]*(tid14[27]-tau2)^3*stepfunktion2(tid14[27]) +
              ydelse14[28]*(tid14[28]-tau2)^3*stepfunktion2(tid14[28]) +
              ydelse14[29]*(tid14[29]-tau2)^3*stepfunktion2(tid14[29]) +
              ydelse14[30]*(tid14[30]-tau2)^3*stepfunktion2(tid14[30]) + 
              ydelse14[31]*(tid14[31]-tau2)^3*stepfunktion2(tid14[31]) +
              ydelse14[32]*(tid14[32]-tau2)^3*stepfunktion2(tid14[32]) +
              ydelse14[33]*(tid14[33]-tau2)^3*stepfunktion2(tid14[33])
delta2
...
delta3[14] <- ydelse14[1]*(tid14[1]-tau3)^3*stepfunktion3(tid14[1]) +
              ydelse14[2]*(tid14[2]-tau3)^3*stepfunktion3(tid14[2]) +
              ydelse14[3]*(tid14[3]-tau3)^3*stepfunktion3(tid14[3]) +
              ydelse14[4]*(tid14[4]-tau3)^3*stepfunktion3(tid14[4]) +
              ydelse14[5]*(tid14[5]-tau3)^3*stepfunktion3(tid14[5]) +
              ydelse14[6]*(tid14[6]-tau3)^3*stepfunktion3(tid14[6]) +
              ydelse14[7]*(tid14[7]-tau3)^3*stepfunktion3(tid14[7]) +
              ydelse14[8]*(tid14[8]-tau3)^3*stepfunktion3(tid14[8]) +
              ydelse14[9]*(tid14[9]-tau3)^3*stepfunktion3(tid14[9]) + 
              ydelse14[10]*(tid14[10]-tau3)^3*stepfunktion3(tid14[10]) +
              ydelse14[11]*(tid14[11]-tau3)^3*stepfunktion3(tid14[11]) +
              ydelse14[12]*(tid14[12]-tau3)^3*stepfunktion3(tid14[12]) +
              ydelse14[13]*(tid14[13]-tau3)^3*stepfunktion3(tid14[13]) +
              ydelse14[14]*(tid14[14]-tau3)^3*stepfunktion3(tid14[14]) +
              ydelse14[15]*(tid14[15]-tau3)^3*stepfunktion3(tid14[15]) +
              ydelse14[16]*(tid14[16]-tau3)^3*stepfunktion3(tid14[16]) +
              ydelse14[17]*(tid14[17]-tau3)^3*stepfunktion3(tid14[17]) +
              ydelse14[18]*(tid14[18]-tau3)^3*stepfunktion3(tid14[18]) +
              ydelse14[19]*(tid14[19]-tau3)^3*stepfunktion3(tid14[19]) + 
              ydelse14[20]*(tid14[20]-tau3)^3*stepfunktion3(tid14[20]) +
              ydelse14[21]*(tid14[21]-tau3)^3*stepfunktion3(tid14[21]) +
              ydelse14[22]*(tid14[22]-tau3)^3*stepfunktion3(tid14[22]) +
              ydelse14[23]*(tid14[23]-tau3)^3*stepfunktion3(tid14[23]) +
              ydelse14[24]*(tid14[24]-tau3)^3*stepfunktion3(tid14[24]) +
              ydelse14[25]*(tid14[25]-tau3)^3*stepfunktion3(tid14[25]) +
              ydelse14[26]*(tid14[26]-tau3)^3*stepfunktion3(tid14[26]) +
              ydelse14[27]*(tid14[27]-tau3)^3*stepfunktion3(tid14[27]) +
              ydelse14[28]*(tid14[28]-tau3)^3*stepfunktion3(tid14[28]) +
              ydelse14[29]*(tid14[29]-tau3)^3*stepfunktion3(tid14[29]) +
              ydelse14[30]*(tid14[30]-tau3)^3*stepfunktion3(tid14[30]) + 
              ydelse14[31]*(tid14[31]-tau3)^3*stepfunktion3(tid14[31]) +
              ydelse14[32]*(tid14[32]-tau3)^3*stepfunktion3(tid14[32]) +
              ydelse14[33]*(tid14[33]-tau3)^3*stepfunktion3(tid14[33])
delta3
```
...
```{r}
parameter <- c(-0.0636021, 0.0657957, -0.0177251, 0.0193602, -0.0020382, 0.0004594)
...
{curve(nulkupon, xlim=c(0.001, tau4),main = "Nulkuponrentekurven 3. april 2020",
...
```{r}
{curve(nulkupon, xlim=c(1.2, tau4),main = "Nulkuponrentekurven 3. april 2020",
     xlab="Tid til udløbsdato (år)", ylab ="Nulkuponrente",col="blue")
abline(v=c(tau1, tau2, tau3, tau4), lwd=0.5, lty=2)
legend(10, 0.01, legend = c("McCulloch's Cubic Spline", "Knudepunker for McCulloch's Cubic Spline"), col = c("blue", "gray30"), lty=c(1,2), cex=0.8, box.lty=1, box.lwd=1, box.col="black")}
```
...
{curve(forward, xlim=c(tid1, tau4),main ="Forwardrentekurven 3. april 2020",
